"""
Thanks to Spectral Normalization for Keras, https://github.com/IShengFang/SpectralNormalizationKeras for this code.
If you use this code, please give the references accordingly.
"""
